...
class Helpers
{
     ...
     * @return string
     */
    public static function validarUrlComFiltro(string $url): string
    {
     ...
     * @return string
     */
    public static function dataFormatada(): string
    {
        $diaMes = date('d');
        $diaSemana = date('w');
        $mes = date('n') - 1;
    ...
    //preg_match()
    public static function verificarTexto(string $texto) : string
    {
    ...
    //preg_match_all()
    public static function verificarEmails()
    {
    ...
    public static function verificarMaldicaoHelloWorld(string $testeDev)
    {
    ...
    //preg_grep()
    public static function filtrarArray()
    {
    ...
    //preg_split()
    public static function dividirString()
    {
